...
def single_root_words(root_word, *other_params):
    same_words = []
    root_word_lower = root_word.lower()
    for i in other_params:
        other_params_lower = i.lower()
        if root_word_lower in other_params_lower or other_params_lower in root_word_lower:
            same_words.append(i)
    print(same_words)
    return same_words
